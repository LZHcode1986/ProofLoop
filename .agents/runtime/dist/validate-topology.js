export function validateRuntimeProofTopology(steps) {
    const errors = [];
    if (steps.length === 0)
        return errors;
    ...
    const serviceStartIds = new Set(steps.filter(s => s.type === 'service_start').map(s => s.id));
...
//# sourceMappingURL=validate-topology.js.map