...
function completedTaskIds(value) {
...
function evidenceRefs(value, completed) {
    ...
    for (const taskId of completed) {
        if (!Object.prototype.hasOwnProperty.call(source, taskId))
            return fail('task_evidence_refs');
    }
    return result;
}
function receipt(value) {
    if (value === null || typeof value !== 'object' || Array.isArray(value))
        return fail('cv_failure_receipt');
    const facts = value;
 ...
 */
export function buildRepairPacket(state, cvFailure) {
