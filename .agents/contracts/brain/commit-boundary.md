...
| `workflow-contract-update` | explicit paths under `.agents/skills`, `.agents/contracts`, `.agents/agent_config.json`, `.opencode/agents` and `.pi/extensions` (no arbitrary `.pi` files) |
