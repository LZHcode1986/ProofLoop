...
- OUT-CONT-01: Slice with Worker Status `ready-for-scv` is detectable
...
## Slice S01-A — Ready for SCV
<!-- SLICE:S01-A:BEGIN -->

### Goal

Simulate a completed slice that is ready for Slice Code Verification.
...
- PO-S01-A-01
  ...
  - Success / Failure: Status is ready-for-scv
  - Required Observation: N/A

### Proof Plan

Primary Seam: Worker Status marker
Required Success Behaviors: Status field reads 'ready-for-scv'
