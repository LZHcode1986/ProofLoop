...
describe('MES operational transaction layer (S06-R-A-T01)', () => {
  ...
  test('mutations stay in isolated fixture roots and never require canonical ignored MES (PO-S08-A-04)', () => {
    const fixture = makeFixture();
    try {
      const layer = createMesTransactionLayer(fixture.dir);
      ...
      assert.ok(!fixtureSnapshot.includes('proofloopv2-wsl-work'), 'no fixture may resolve to the old project tree');
    } finally {
      fixture.cleanup();
    }
