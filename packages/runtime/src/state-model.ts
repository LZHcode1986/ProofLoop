 ...
 */
export const RUNTIME_ACTION_ENTITIES = ['stage', 'slice', 'cv', 'project'] as const;
...
export type RuntimeAction =
  | { readonly entity: 'stage'; readonly event: StageEvent }
  | { readonly entity: 'slice'; readonly event: SliceEvent }
  | { readonly entity: 'cv'; readonly event: CvEvent }
  | { readonly entity: 'project'; readonly event: ProjectEvent };
