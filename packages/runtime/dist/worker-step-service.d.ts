 ...
 */
import type { WorkerRelayPort, WorkerRelayStepResult, WorkerDispatchPacket, WorkerSliceInvalidation, WorkerStepMode, WorkerContinuation } from './relay-contract';
/**
 ...
 */
export declare class WorkerStepService {
    private readonly port;
    constructor(port: WorkerRelayPort);
    executeStep(input: WorkerStepDispatchInput, signal?: AbortSignal): Promise<WorkerRelayStepResult>;
    invalidateSlice(input: WorkerSliceInvalidation): Promise<void>;
}
//# sourceMappingURL=worker-step-service.d.ts.map